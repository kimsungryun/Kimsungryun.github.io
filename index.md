...
## [3주차]
로봇 조립 칸을 마련한다. (유닛 LAB) (0%) (LAB만들기전 UI구성부터 할예정 현재 구성중)
게임시작시 출현하는 몬스터(기지)를 구현한다. (Base LAB 추가 구현 예정) (50%) (현재 기지오브젝트를 제작중이어서 제작되는즉시 구현가능)
시작화면에서 게임시작을 누르면 게임화면으로 들어간다.(100%)
2주차에 구현하지 못한 배경&효과음 조절을 가능하게 구현한다. (100%)
오브젝트를 생성하여 움직임을 형성시키고 AI를 구현한다. (70%) (오브젝트 생성 및 움직임 구현, AI구현 공부중)
https://github.com/kimsungryun/Kimsungryun.github.io/blob/main/img/1.png
